# Applications 
Once the time comes to open applications for the internship, the website for accepting applications and the application itself needs to be created.
## Qualtrics is used to create and distribute the application for the ITS Internship. The application should include questions like: 
...
* Eligibility to work in the U.S/ Michigan
...
## Possible Questions to ask the candidates 
